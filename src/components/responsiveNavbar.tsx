...
// Mude os IDs aqui para valores que correspondam às seções na sua página
const navbarData = [
        ...
        <ul className="text-white text-semibold text-xl flex flex-col gap-2 w-full">
          ...
          <li className="py-2 mt-4">
            <a
              ...
              className="bg-gray-100 text-zinc-900 font-bold px-6 py-2 rounded-2xl w-full block text-center"
              onClick={handleLinkClick}
            >
              Curriculo
            </a>
