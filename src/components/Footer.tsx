    ...
    return (
        <div className="flex items-center flex-col justify-center mx-30 mt-20">
            <div className="w-4xl items-center justify-center border  border-[#919191]/30 bg-white/4 py-3 px-4 backdrop-blur-[1.5px] rounded-2xl">
                ...
                <div className='mx-8'>
                    <h3 className="text-2xl md:py-8 py-4 text-white" >Vamos Trabalhar Juntos</h3>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <span className='text-xs font-light flex justify-center text-white/40'>Usually responds within 24 hours</span>
                        ...
                        <div className='flex justify-center gap-2 items-center'>
                            ...
                            <a
                                href="https://twitter.com/nicius__" // Substitua pelo seu perfil
                                target="_blank"
                                rel="noopener noreferrer"
                            >
            ...
            <div>
                <div className='w-screen flex justify-center h-14 bg-zinc-950/40 border-t-[0.25px] border-white/10'>
                    <span className='text-zinc-500 flex items-center'>© 2025 Vini | Portfolio by Vinícius Campos</span>
                </div>
            </div>
        </div>
